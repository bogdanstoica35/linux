...
#EMAIL_LIST1=bogdan@vrem.ro
EMAIL_LIST2=server@simonolsen.com.au
...
#cat /var/log/mail_report | mail -s "Volume Snapshots Status" $EMAIL_LIST1
cat /var/log/mail_report | mail -s "Volume Snapshots Status" $EMAIL_LIST2
